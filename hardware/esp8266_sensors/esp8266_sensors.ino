/*
  D-SQUARE 2.0 - IoT Ground Station Node Firmware (Fixed Direct Local HTTP)
*/
...
// Direct Local IP Endpoint (Fast & SSL-Free for ESP8266):
const char* localServerUrl = "http://10.172.49.122:5001/api/sensor_data";

// Fallback HTTPS Tunnel Endpoint:
